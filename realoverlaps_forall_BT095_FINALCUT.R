...
overlap_fraction <- function(gr1, gr2) {
  hits <- findOverlaps(gr1, gr2, ignore.strand = TRUE)
  length(unique(queryHits(hits))) / length(gr1)
}


ov_1_2 <- overlap_fraction(bc095_100_exp1, bc095_100_exp2)
ov_2_1 <- overlap_fraction(bc095_100_exp2, bc095_100_exp1)
ov_1_3 <- overlap_fraction(bc095_100_exp1, bc095_100_TLDR)
ov_1_4 <- overlap_fraction(bc095_100_exp1, bc095_100_SLIC)
ov_2_3 <- overlap_fraction(bc095_100_exp2, bc095_100_TLDR)
ov_2_4 <- overlap_fraction(bc095_100_exp2, bc095_100_SLIC)
ov_3_4 <- overlap_fraction(bc095_100_TLDR, bc095_100_SLIC)
