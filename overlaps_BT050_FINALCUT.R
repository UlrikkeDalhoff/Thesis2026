...
# Combine all regions
all_regions_BT050_200 <- GenomicRanges::reduce(c(
  bc050_200_exp1,
  bc050_200_exp2,
  bc050_200_TLDR,
  bc050_200_SLIC
...
# Combine all regions
all_regions_BT050_400 <- GenomicRanges::reduce(c(
  bc050_400_exp1,
  bc050_400_exp2,
  bc050_400_TLDR,
  bc050_400_SLIC
...
# Combine all regions
all_regions_BT050_600 <- GenomicRanges::reduce(c(
  bc050_600_exp1,
  bc050_600_exp2,
  bc050_600_TLDR,
  bc050_600_SLIC
...
# Combine all regions
all_regions_BT050_800 <- GenomicRanges::reduce(c(
  bc050_800_exp1,
  bc050_800_exp2,
  bc050_800_TLDR,
  bc050_800_SLIC
